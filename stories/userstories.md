...
| **Acceptance Criteria** | - Support for major wallet providers (MetaMask, Trust Wallet, etc.).<br>- Wallet connection status visible in UI.<br>- One-click payment from connected wallet.<br>- Transaction history viewable in user dashboard. |
| **Priority**            | High                                                                                                                                                                                                                 |
| **Story Points**        | 5                                                                                                                                                                                                                    |
